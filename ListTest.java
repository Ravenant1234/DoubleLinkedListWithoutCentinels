...
public class ListTest {
	...
	private PositionList<String> getList() {
		return new DoubleLinkedListSinCentinelas<String>();
	}
	...
	/*
	 * _______________________TESTEAMOS EL METODO
	...
	public void size() {
		...
		assertTrue("Tama�o de la lista justo despu�s de ser creada != 0", l.size() == 0);
		// Caso_de_prueba: Lista con un �nico elemento.
		l.addLast(n1);
		assertTrue("Tama�o de la lista luego de insertar un elemento != 1", l.size() == 1);
		// Caso_de_prueba: Lista con varios elementos.
		l.addLast(n2);
		assertTrue("Tama�o de la lista luego de insertar dos elementos != 2", l.size() == 2);
		l.addLast(n3);
		assertTrue("Tama�o de la lista luego de insertar tres elementos != 3", l.size() == 3);
		try {
			l.remove(l.first());
			assertTrue("El tama�o de la lista luego de insertar 3 elementos y eliminar uno es != 2", l.size() == 2);
			l.remove(l.last());
			assertTrue("El tama�o de la lista luego de insertar 3 elementos y eliminar dos es != 1", l.size() == 1);
			l.remove(l.first());
			assertTrue("El tama�o de la lista luego de insertar 3 elementos y eliminar los tres es != 0",
					l.size() == 0);
	...
	/*
	 * _______________________TESTEAMOS EL METODO
	 * isEmpty()_____________________________
	 */

	@Test
	public void isEmpty() {
		// Caso_de_prueba: Lista Vac�a.
		assertTrue("La lista no est� vac�a justo despu�s de ser creada", l.isEmpty());
		// Caso_de_prueba: Lista con un �nico elemento.
		l.addFirst(n1);
		assertFalse("La lista est� vac�a justo despu�s de insertar un elemento", l.isEmpty());
		// Caso_de_prueba: Lista con varios elementos.
		for (int i = 0; i < 10; i++) {
			l.addFirst(n1);
			assertFalse("La lista est� vac�a justo despu�s de insertar elementos", l.isEmpty());
		}
		try {
			for (int i = 0; i < 10; i++) {
				l.remove(l.first());
				assertFalse("La lista est� vac�a teniendo elementos", l.isEmpty());
			}
		} catch (InvalidPositionException e) {
		...
		try {
			l.remove(l.first());
			assertTrue("La lista no est� vac�a luego de eliminar el �nico elemento que conten�a", l.isEmpty());
		} catch (InvalidPositionException e) {
			fail("Al eliminar un elemento de una lista con un �nico elemento lanza la excepci�n InvalidPositionException");
		} catch (EmptyListException e) {
			fail("Al solicitar la primer posici�n de una lista que no est� vac�a lanza la excepci�n EmptyListException");
	...
	public void last() {
		...
		try {
			...
			fail("Al solicitar la �ltima posici�n de una lista que no est� vac�a se lanza la excepci�n EmptyListException");
		}
		try {
			l.remove(l.last());
	...
	public void next() {
		...
		try {
			...
			fail("Al solicitar la �ltima posici�n de una lista que no est� vac�a lanza la excepci�n EmptyListException");
		}
		...
		try {
			...
			fail("Al solicitar la primer posici�n de la lista no deber�a lanzar la excepci�n EmptyListException");
		}
		try {
			cursor = l.next(cursor);
			fail("next() no deber�a lanzar la excepci�n BoundaryViolationException con una posici�n distinta a la �ltima posici�n de la lista");
	...
	/*
	 * _______________________TESTEAMOS EL METODO
	 * prev()_____________________________
	 */
	...
	/*
	 * _______________________TESTEAMOS EL METODO
	 * addFirst()_________________________
	 */
	...
	/*
	 * _______________________TESTEAMOS EL METODO
	 * addLast()___________________________
	 */
	...
	/*
	 * _______________________TESTEAMOS EL METODO
	 * addAfter()___________________________
	 */
	...
	public void addAfter() {
		...
		try {
			...
			fail("Al solicitar la primer o �ltima posici�n de una lista que no est� vac�a lanza la excepci�n EmptyListException");
		}
		// Caso_de_prueba: Lista con varios elementos (Hacia adelante).
		try {
			cursor = l.first();
	...
	/*
	 * _______________________TESTEAMOS EL METODO
	 * addAfter()____________________________
	 */
	...
	public void addBefore() {
		...
		try {
			...
			fail("Al solicitar la �ltima y primer posici�n de una lista que no est� vac�a lanza la excepci�n EmptyListException");
		}
		// Caso_de_prueba: Lista con varios elementos (Hacia adelante).
		try {
			cursor = l.first();
	...
	/*
	 * _______________________TESTEAMOS EL METODO
	 * iterator()_____________________________
	 */
